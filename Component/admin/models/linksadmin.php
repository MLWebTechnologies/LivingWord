 ...
 * @since       1.5
 */
class LivingWordModelLinksAdmin extends JModelAdmin
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_livingword.link', 'link', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_livingword.edit.link.data', array());
		if (empty($data))
		{
			$data = $this->getItem();
		}
