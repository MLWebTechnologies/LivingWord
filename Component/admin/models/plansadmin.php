 ...
 * @since       1.5
 */
class LivingWordModelPlansAdmin extends JModelAdmin
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_livingword.plans', 'plans', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form))
		{
			return false;
		}
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_livingword.edit.plans.data', array());
		if (empty($data))
		{
			$data = $this->getItem();
		}
